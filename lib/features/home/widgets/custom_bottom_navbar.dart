...
//   // 1. Menambahkan parameter untuk mengetahui halaman mana yang sedang aktif
//   final int selectedIndex;
//   // 2. Callback ketika item ditekan
//   final Function(int) onItemTapped;
//   // 3. Callback khusus untuk tombol Scan (tengah)
...
//     const double touchAreaHeight = 160.0; // Area sentuh diperluas ke atas
...
//                 // Opsional: Tambah rounded di pojok atas jika diinginkan
...
//                   _buildNavIcon(
//                     label: "HOME",
//                     // Logika: Jika index 0 (Home), pakai icon fill, jika tidak pakai stroke
//                     // Catatan: Karena Anda hanya punya 1 file icon, kita mainkan Opacity/Color
//                     // Jika Anda punya 'ic_home_stroke.svg', ganti logikanya di sini.
...
//               onTap: onScanTap, // Panggil callback scan
//               child: Stack(
...
//           // ===========================
//           // 3. BIRTHDAY ICON (HIASAN)
//           // ===========================
//           // Saya pertahankan posisinya tapi menghapus logic popup-nya dari sini
//           // Jika ini hanya hiasan dan tidak bisa diklik di semua halaman, 
//           // biarkan onTap kosong atau hapus GestureDetector-nya.
//           Positioned(
//             left: 24,
...
//             height: 32,
//             // LOGIKA WARNA:
//             // Jika Active (Halaman sekarang) -> Putih Solid (100%)
//             // Jika Inactive (Halaman lain) -> Putih Transparan (60%) 
//             // Ini mensimulasikan efek "Stroke/Tidak Fokus" tanpa perlu aset baru.
...
//             style: TextStyle(
//               fontSize: 12,
//               fontWeight: isActive ? FontWeight.w700 : FontWeight.w400, // Bold jika aktif
