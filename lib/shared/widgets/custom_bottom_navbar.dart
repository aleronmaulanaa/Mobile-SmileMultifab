        ...
        children: [
          ...
          Positioned(
            ...
            child: Container(
              ...
              decoration: const BoxDecoration(
                color: Color(0xFF991B1C),
                // Opsional: memberi sedikit lengkungan di sudut atas bar
          ...
          // 2. Tombol Scan (Tengah) - SUDAH DITAMBAHKAN GESTURE DETECTOR
          Positioned(
            bottom: scanBottomPos,
            child: GestureDetector(
              onTap: () {
                // Navigasi ke halaman Scan (Pastikan route '/scan' sudah didaftarkan di main.dart)
              ...
              child: Stack(
                ...
                children: [
                  Container(
                    ...
                    decoration: const BoxDecoration(
                      color: Color(
                          0xFFF3F4F6), // Warna sama dengan background scaffold
                      shape: BoxShape.circle,
                      boxShadow: [
                        BoxShadow(
                            color: Colors.black12,
