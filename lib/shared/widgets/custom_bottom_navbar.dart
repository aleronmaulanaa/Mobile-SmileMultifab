...
class CustomBottomNavBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // TETAP: Tinggi Bar Merah tidak berubah (sesuai permintaan)
    const double navHeight = 78.0;

    // BERUBAH: Tinggi Area Pembungkus (Invisible Touch Area)
    // - Jika Home (ada Birthday): Butuh 160.0 agar tombol birthday muat.
    // - Jika Profile (tanpa Birthday): Cukup 125.0 (sekedar muat tombol Scan).
    //   Ini menghilangkan "Zona Kosong" di atas navbar.
    ...
    return SizedBox(
      height: touchAreaHeight, // <--- Ini yang mengecil saat di Profile
      child: Stack(
        alignment: Alignment.bottomCenter,
        clipBehavior: Clip.none,
        children: [
          // ==============================
          // 1. BACKGROUND BAR MERAH (Tetap 78px)
          // ==============================
          Positioned(
            bottom: 0,
            left: 0,
          ...
          // ==============================
          // 3. BIRTHDAY BUTTON (Hilang Total)
          // ==============================
          if (showBirthday)
            Positioned(
              left: 24,
